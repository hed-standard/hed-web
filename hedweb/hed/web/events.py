...
def generate_input_from_events_form(request):
    ...
    input_arguments = {
        ...
        common.SPREADSHEET_PATH: uploaded_events_name,
        common.SPREADSHEET_FILE: original_events_name,
...
def events_validate(input_arguments):
    ...
    download_response = dictionary_validate(input_arguments, hed_schema=hed_schema)
