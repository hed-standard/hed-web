...
[Chapter 6: Infrastructure](https://hed-specification.readthedocs.io/en/latest/06_Infrastructure.html##6-infrastructure) of the HED specification.
...
of the HED specification defines some important HED tags and terminology used in HED.)
