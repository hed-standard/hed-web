...
class Test(unittest.TestCase):
    ...
    def test_string_convert_to_long(self):
        ...
        arguments = {common.COMMAND: common.COMMAND_TO_LONG, 'hed_xml_file': schema_path,
                     'hed_display_name': 'HED 7.1.2.xml', 'string_list': ['Red, Blue']}
        ...
        arguments = {common.COMMAND: common.COMMAND_TO_LONG, 'hed_xml_file': schema_path,
                     'hed_display_name': 'HED8.0.0-alpha.1.xml', 'string_list': ['Red, Blue']}
        with self.app.app_context():
            response = string_convert(arguments)
