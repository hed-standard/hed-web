    ...
    def test_events_results_assemble_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                ...
                "Assembly of a valid events file has a response",
            )
    ...
    def test_events_results_assemble_invalid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Assembly of invalid events files has a response",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "warning",
    ...
    def test_events_results_remodel_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Remodeling valid file has a valid status code",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "success",
    ...
    def test_events_results_validate_valid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Validation of a valid events file has a valid status code",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "success",
    ...
    def test_events_results_validate_invalid(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                200,
                response.status_code,
                "Validation of invalid events files has a response",
            )
            headers_dict = dict(response.headers)
            self.assertEqual(
                "warning",
    ...
    def test_events_results_validate_bad_file(self):
        with self.app.app_context():
            ...
            self.assertEqual(
                "error",
                headers_dict["Category"],
                "The invalid events file not validate",
            )
